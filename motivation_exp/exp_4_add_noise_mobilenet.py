...
# Add noise
# add_noise_to_layer(net.layer0, std_dev=0.1)
# add_noise_to_layer(net.layer1, std_dev=0.1)

add_noise_to_layer(net.fc, std_dev=4)
...
layer0_layer1 = chain(net.layer0.parameters(), net.layer1.parameters())
# optimizer_ft = optim.SGD(layer0_layer1, lr=learning_rate_ft, momentum=0.9, weight_decay=5e-4)
optimizer_ft = optim.SGD(net.layer2.parameters(), lr=learning_rate_ft, momentum=0.9, weight_decay=5e-4)
fine_tune_epochs = 50
...
for epoch in range(fine_tune_epochs):
    ...
    if valid_loss < min_val_loss:
        ...
        epochs_no_improve = 0
        torch.save(net.state_dict(), '/home/yushan/adaptive_personalization/motivation_exp/model/mobilenet_model_ft_l1.pth')
    else:
        epochs_no_improve += 1
...
# load the best model
net.load_state_dict(torch.load('/home/yushan/adaptive_personalization/motivation_exp/model/mobilenet_model_ft_l1.pth'))
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('/home/yushan/adaptive_personalization/motivation_exp/fig/loss_single_mobilenet.png')
